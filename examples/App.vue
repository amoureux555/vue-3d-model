<template>
  <div class="examples">
    <div class="examples-header">
      <a href="https://github.com/hujiulong/vue-3d-model" class="title"
        >Vue3DModel</a
      >
      <a href="https://github.com/hujiulong/vue-3d-model" class="github"
        >View on GitHub</a
      >
    </div>
    <div class="examples-content">
      <ul class="examples-menu">
        ...
        <li class="examples-menu-title">demo</li>
        <li class="examples-menu-item">
          <router-link to="demo-zhujian">住建大厦高1 (.fbx)</router-link>
        </li>
        <li class="examples-menu-item">
          <router-link to="demo-gongjiao">公交站台 (.fbx)</router-link>
        </li>
        <li class="examples-menu-item">
          <router-link to="demo-huashe">华设西侧工地1009(.fbx)</router-link>
        </li>
        <li class="examples-menu-item">
          <router-link to="demo-lunan">路南侧工地(.fbx)</router-link>
        </li>
        <li class="examples-menu-item">
          <router-link to="demo-shimao">世贸君望墅(.fbx)</router-link>
        </li>
        <li class="examples-menu-title">focus</li>
        <li class="examples-menu-item">
          <router-link to="demo-focus">集中(.fbx)</router-link>
        </li>
      </ul>
